...
Only one customer can be served at a time. Therefore, if a customer arrives while the server is busy, the customer must wait in the queue.

The service start time is calculated as:
...
The following screenshots are included to demonstrate the working simulation:

| Screenshot File | Description |
|---|---|
| `terminal-output.png` | Shows the terminal output header and customer results table |
| `saving-out-as-txt.png` | Shows the terminal output being saved to a text file |
| `simulationresults1.png` | Shows the first 30 rows of the simulation results |
| `simulationresults2.png` | Shows the remaining rows of the simulation results |
| `simulationresults.png` | Shows the summary statistics generated by the program |
| `graph-output.png` | Shows the Java Swing visualization graph |
